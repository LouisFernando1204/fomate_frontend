...
class PaymentLifeTimeDealPage extends StatefulWidget {
  PaymentLifeTimeDealPage({super.key});

  @override
  State<PaymentLifeTimeDealPage> createState() =>
      _PaymentLifeTimeDealPageState();
}

class _PaymentLifeTimeDealPageState extends State<PaymentLifeTimeDealPage> {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ListView.builder(
                                      ...
                                      itemCount:
                                          value.contentList.data?.length ?? 0,
                                      itemBuilder: (context, index) {
                                        var content =
                                            value.contentList.data![index];
                                        return Padding(
                                                ...
                                                children: [
                                                  Text(
                                                    content.contentTitle!
                                                                .length >
                                                            15
                                                        ? '${content.contentTitle!.substring(0, 25)}...'
                                                        : content.contentTitle!,
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.w600,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Rp. ${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((149900) * (5 / 100))}",
                                          style: TextStyle(
                                            fontWeight: FontWeight.w600,
                                            fontFamily: 'Poppins',
                                            fontSize: 14,
